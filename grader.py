...
class Grader():
    ...
    def grade_assignment_1(self):
        try:
            ...
            expected_results=[f2,f3,f9,f4,f13,f1,f7]
    ...
    def grade_assignment_3_integrate(self):
        try:
            import assignment3
            R = RESTRICT_INVOCATIONS
            repeats = 15
            names= ('f'   ,'a','b','n')
            valss=[(R(4*repeats)(f1)    ,2  ,5  ,4  ),
                   (R(10*repeats)(f2)    ,2  ,10 ,10 ),
                   (R(4*repeats)(f3)    ,5  ,1.5,4  ),
                   (R(20*repeats)(f13_nr), 2, 4, 20),
                   (R(10*repeats)(f12_nr), 5, 8, 10)
                   ]
            params=[dict(zip(names,vals)) for vals in valss]
            expected_results=[
                    15,
            ...
            self.grade_assignment(ass.integrate,params,'Assignment 3',func_error,expected_results,repeats)
        except Exception as e:
    ...
    def grade_assignment_3_areabetween(self):
        try:
            ...
            valss = [(f10, f6),
                     ...
                     (f1, f15),
                     (f1, f16)]
            params = [dict(zip(names, val)) for val in valss]
            expected_results = [
                14.0539,
                0.731257,
                60,
            ...
            self.add_error_report('Assignment 3B', 'areabetween', e, 1)
    ...
    def grade_assignment_4(self):
        try:
            ...
            params=[dict(zip(names,vals)) for vals in valss] 
            expected_results=[f2,f3,f9, f4, f13, f1, f7, f6]
    ...
    def grade(self):
        ...
        # print('############################# ASSIGNMENT 3 INTEGRATE ############################')
        # self.grade_assignment_3_integrate()
        # print('############################# ASSIGNMENT 3 AREABETWEEN ############################')
        # self.grade_assignment_3_areabetween()
        # print('############################# ASSIGNMENT 4 ############################')
        # self.grade_assignment_4()
        print('############################# ASSIGNMENT 5 AREA ############################')
        self.grade_assignment_5_area()
        print('############################# ASSIGNMENT 5 FIT ############################')
